"""
Django settings for corvida project.
...
SECRET_KEY = 'django-insecure-29im6b_8j@8gpid^q!aofo-a^m)0_=tlmyi!%*r@k2xnl^%-ef'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
AUTH_USER_MODEL = 'world.CustomUser'
...
ROOT_URLCONF = 'corvida.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # للمجلد الرئيسي
        'APP_DIRS': True,  # يبحث في مجلد templates داخل كل تطبيق
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'corvida.wsgi.application'
